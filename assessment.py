...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    """
    foods_in_common = set(foods1) & set(foods2)
...
def largest_n_items(items, n):  # n = the how many numbers to pull from list
    ...
    return sorted(items)[-n:] # this one took me awhile mostly because I was over thinking the problem
